...
<div id="contact_block" class="block">
	...
	<div class="block_content clearfix">
			...
			{if $whatsapp_number != ''}<p class="whatsapp"><span class="label">{l s='WhatsApp:' mod='blockcontact'}</span><a href="https://wa.me/{$whatsapp_number|escape:'html':'UTF-8'|replace:'+':''|replace:'-':''|replace:' ':''}">{$whatsapp_number|escape:'html':'UTF-8'}</a></span></p>{/if}
